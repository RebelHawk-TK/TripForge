            ...
            {[
              {
                ...
                price: "$0",
                period: "forever",
                features: ["3 itineraries per day", "Day-by-day AI plan", "Real restaurants & attractions", "Shareable link"],
                cta: "Start Free",
                style: "secondary",
              },
              {
                ...
                price: "$25",
                period: "per trip",
                features: ["Everything in Free", "Flight & hotel samples", "Restaurant reservations via Viator", "Budget breakdown + PDF export"],
                cta: "Get Basic",
                style: "primary",
                popular: true,
              },
              {
                ...
                price: "$49",
                period: "per trip",
                features: ["Everything in Basic", "Full AI booking coordination", "Tour bookings via Viator", "Unlimited revisions + priority support"],
                cta: "Go Enhanced",
                style: "teal",
              },
            ].map((tier) => (
